...
RUN rpm-ostree override remove kernel kernel-core kernel-modules kernel-modules-extra --install kernel-cachyos-bore-lto kernel-cachyos-bore-lto-modules kernel-cachyos-bore-lto-core


RUN rpm-ostree override remove firefox firefox-langpacks && \
    rpm-ostree install libratbag-ratbagd vim zsh blackbox-terminal && \
